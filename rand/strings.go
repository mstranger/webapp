...
// return on error if there was one. This uses the crypto/rand
...
// RememberToken is a helper function disigned to generate
// remember tokesn of a predeterminated byte size.
